...
Assistantnme = env_vars.get('Assistantname')
DefaultMessage = f'''{Username} : Hello {Assistantnme}, How are you?
{Assistantnme} : Welcome {Username}. I am doing well. How may I help you?'''
...
def ChatLogIntegration():
    ...
    formatted_chatlog = formatted_chatlog.replace("Assistant",Assistantnme + " ")
...
def MainExecution():
    ...
    if ImageExecution == True:
        ...
        try:
            p1 = subprocess.Popen([sys.executable,"Backend\\ImageGeneration.py"],
    ...
    if G and R or R:
        ...
        ShowTextToScreen(f"{Assistantnme} : {Answer}")
