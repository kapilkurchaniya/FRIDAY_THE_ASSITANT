...
class ChatSection(QWidget):
    ...
    def addMessages(self,message,color):
        ...
        formatt.setForeground(QColor(color))
...
class CustomTopBar(QWidget):
    ...
    def iniUI(self):
        ...
        minimize_button.clicked.connect(self.minizeWindow)
        ...
        # logo_label = QPixmap(GraphicsDirectoryPath("logo.jpeg"))
        # logo_label.scaled(5,5)
        # title_label.setPixmap(logo_label)
        title_label2 = QLabel()
        pixmap = QPixmap(GraphicsDirectoryPath("logo.jpeg"))
        new_pixmap = pixmap.scaled(30,30)
        title_label2.setPixmap(new_pixmap)
        title_label2.setFixedSize(40,40)
        title_label2.setAlignment(Qt.AlignCenter)
        title_label2.setStyleSheet("background-color: white;")
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowIcon(QIcon(GraphicsDirectoryPath("logo.jpeg")))
        self.setWindowTitle("AI-Verse || Voice Mode")
